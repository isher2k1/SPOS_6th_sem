...
public class cp
{
  ...
  public static final short OUTPUT_MODE = 0666 ;
   ...
   */
  public static void main( Vector argv ) throws Exception
  {
    ...
    String in_name = (String) argv.elementAt(0) ;
    String out_name = (String) argv.elementAt(1) ;
    ...
    int out_fd = Kernel.creat( out_name , 
      (short) ( Kernel.S_IFREG | OUTPUT_MODE ) ) ;
    if( out_fd < 0 )
    {
      Kernel.perror( PROGRAM_NAME ) ;
