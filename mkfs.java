...
public class mkfs
{
   ...
   */
  public static void main( Vector<String> argv ) throws Exception
  {
    if( argv.size() != 3 )
    {
      System.err.println( 
    ...
    String filename = (String) argv.elementAt(0) ;
    short block_size = (short) Integer.parseInt( (String) argv.elementAt(1) ) ;
    int blocks = Integer.parseInt( (String) argv.elementAt(2) ) ;
    int block_total = 0 ;
    ...
    */
    ...
    rootIndexNode.setMode( (short) (Kernel.S_IFDIR | 0777 &~ 022) ) ;
