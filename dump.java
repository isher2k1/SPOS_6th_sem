...
public class dump
{
  ...
  public static void main( Vector args )
  {
    for ( int i = 0 ; i < args.size() ; i ++ )
    {
      ...
      try
      {
        FileInputStream ifile = new FileInputStream( (String) args.elementAt(i) ) ;
      ...
      {
        System.out.println( "error: unable to open input file " + (String)args.elementAt(i) ) ;
      }
      catch ( IOException e )
      {
        System.out.println( "error: unable to read from file " + (String)args.elementAt(i) ) ;
      }
    }
  }
