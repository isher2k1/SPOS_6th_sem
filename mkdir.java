...
public class mkdir
{
  ...
  /**
   * The file mode to use when creating the output directory.
   */
  public static final short OUTPUT_MODE = 0777 ;
  /**
  ...
  public static void main( Vector<String> args ) throws Exception
  {
    ...
    for( int i = 0 ; i < args.size() ; i ++ )
    {
      ...
      int newDir = Kernel.creat( name , 
        (short) (Kernel.S_IFDIR | OUTPUT_MODE ) ) ;
      if( newDir < 0 )
      {
      ...
      System.out.println("The directory was created with success.");
    }
